// This code is modified by Genouka.
...
string importFolder = Environment.GetEnvironmentVariable("Genouka_MVZ2_Port_SoundImport_Folder");

string[] dirFiles = Directory.GetFiles(importFolder);
string folderName = new DirectoryInfo(importFolder).Name;

bool emergencyCancel = false;
...
SetProgressBar(null, "Fixer Importing sounds", 0, maxCount);
