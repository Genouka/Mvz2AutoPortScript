...
.method notifyChildrenChangedForCompatOnHandler(Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 445
    iget-object v2, p1, Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;->subscriptions:Ljava/util/HashMap;
    ...
    invoke-virtual {v4, p2, p1, v2, p3}, Landroid/support/v4/media/MediaBrowserServiceCompat;->performLoadChildren(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/os/Bundle;Landroid/os/Bundle;)V
...
.method public onGetRoot(Ljava/lang/String;ILandroid/os/Bundle;)Landroid/support/v4/media/MediaBrowserServiceCompatApi21$BrowserRoot;
    ...
    .line 351
    .local v9, "rootExtras":Landroid/os/Bundle;
    if-eqz p3, :cond_0
    ...
    .end local v9    # "rootExtras":Landroid/os/Bundle;
    invoke-direct {v9}, Landroid/os/Bundle;-><init>()V

    .line 355
    .restart local v9    # "rootExtras":Landroid/os/Bundle;
    ...
    invoke-static {v9, v0, v1}, Landroid/support/v4/app/BundleCompat;->putBinder(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    .line 359
    .local v7, "extraBinder":Landroid/support/v4/media/session/IMediaSession;
    ...
    :goto_0
    invoke-static {v9, v1, v0}, Landroid/support/v4/app/BundleCompat;->putBinder(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V

    .line 367
    .end local v7    # "extraBinder":Landroid/support/v4/media/session/IMediaSession;
    :cond_0
    :goto_1
    iget-object v10, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImplApi21;->this$0:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    iput-object v0, v10, Landroid/support/v4/media/MediaBrowserServiceCompat;->mCurConnection:Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;
    ...
    .line 371
    .local v8, "root":Landroid/support/v4/media/MediaBrowserServiceCompat$BrowserRoot;
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImplApi21;->this$0:Landroid/support/v4/media/MediaBrowserServiceCompat;

    iput-object v6, v0, Landroid/support/v4/media/MediaBrowserServiceCompat;->mCurConnection:Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;
    ...
    .line 360
    .end local v8    # "root":Landroid/support/v4/media/MediaBrowserServiceCompat$BrowserRoot;
    .restart local v7    # "extraBinder":Landroid/support/v4/media/session/IMediaSession;
    :cond_1
    invoke-interface {v7}, Landroid/support/v4/media/session/IMediaSession;->asBinder()Landroid/os/IBinder;
    ...
    .line 375
    .restart local v8    # "root":Landroid/support/v4/media/MediaBrowserServiceCompat$BrowserRoot;
    :cond_3
    if-nez v9, :cond_5
    ...
    invoke-direct {v6, v0, v9}, Landroid/support/v4/media/MediaBrowserServiceCompatApi21$BrowserRoot;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V
