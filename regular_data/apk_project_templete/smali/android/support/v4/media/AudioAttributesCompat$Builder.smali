...
.method public build()Landroid/support/v4/media/AudioAttributesCompat;
    ...
    .local v1, "impl":Landroid/support/v4/media/AudioAttributesImpl;
    :goto_0
    new-instance v2, Landroid/support/v4/media/AudioAttributesCompat;

    invoke-direct {v2, v1}, Landroid/support/v4/media/AudioAttributesCompat;-><init>(Landroid/support/v4/media/AudioAttributesImpl;)V

    return-object v2

    .line 435
    .end local v1    # "impl":Landroid/support/v4/media/AudioAttributesImpl;
    :cond_1
    ...
    iget v4, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mUsage:I

    iget v5, p0, Landroid/support/v4/media/AudioAttributesCompat$Builder;->mLegacyStream:I

    invoke-direct {v1, v2, v3, v4, v5}, Landroid/support/v4/media/AudioAttributesImplBase;-><init>(IIII)V

    .restart local v1    # "impl":Landroid/support/v4/media/AudioAttributesImpl;
    goto :goto_0
.end method
...
.method public setLegacyStreamType(I)Landroid/support/v4/media/AudioAttributesCompat$Builder;
    ...
    .line 556
    .end local p0    # "this":Landroid/support/v4/media/AudioAttributesCompat$Builder;
    :cond_1
    return-object p0
.end method
