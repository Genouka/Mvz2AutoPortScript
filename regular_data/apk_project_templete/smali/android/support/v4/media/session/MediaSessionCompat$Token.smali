...
.method public static fromBundle(Landroid/os/Bundle;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 1720
    invoke-static {p0, v4}, Landroid/support/v4/app/BundleCompat;->getBinder(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 1721
    .local v0, "extraSession":Landroid/support/v4/media/session/IMediaSession;
    const-string v4, "android.support.v4.media.session.SESSION_TOKEN2_BUNDLE"
    ...
    .line 1723
    .local v1, "token":Landroid/support/v4/media/session/MediaSessionCompat$Token;
    if-eqz v1, :cond_0

    new-instance v3, Landroid/support/v4/media/session/MediaSessionCompat$Token;

    iget-object v4, v1, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mInner:Ljava/lang/Object;

    invoke-direct {v3, v4, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Landroid/os/Bundle;)V
