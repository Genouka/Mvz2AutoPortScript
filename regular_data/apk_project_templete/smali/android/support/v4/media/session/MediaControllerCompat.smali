...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    iput-object v3, p0, Landroid/support/v4/media/session/MediaControllerCompat;->mRegisteredCallbacks:Ljava/util/HashSet;
    ...
    const-string v4, "session must not be null"
    ...
    iput-object v3, p0, Landroid/support/v4/media/session/MediaControllerCompat;->mToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    .line 248
    const/4 v1, 0x0

    .line 250
    .local v1, "impl":Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    :try_start_0
    ...
    .line 251
    new-instance v2, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi24;
    ...
    invoke-direct {v2, p1, v3}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi24;-><init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .end local v1    # "impl":Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    .local v2, "impl":Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    move-object v1, v2

    .line 262
    .end local v2    # "impl":Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    .restart local v1    # "impl":Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    :goto_0
    ...
    .line 253
    new-instance v2, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi23;

    iget-object v3, p0, Landroid/support/v4/media/session/MediaControllerCompat;->mToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    invoke-direct {v2, p1, v3}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi23;-><init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V

    .end local v1    # "impl":Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    .restart local v2    # "impl":Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    move-object v1, v2
    ...
    invoke-direct {v2, p1, v3}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;-><init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    .line 257
    :cond_3
    new-instance v2, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;

    iget-object v3, p0, Landroid/support/v4/media/session/MediaControllerCompat;->mToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    invoke-direct {v2, v3}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    :try_end_1
    ...
    const-string v4, "Failed to create MediaControllerImpl."
