.class public Lyuanwow/foxr/starter/ui/MapTable;
.super Ljava/lang/Object;
.source "MapTable.java"
...
.method static final constructor <clinit>()V
    ...
    const-string v3, "application/x-authoware-bin"
    ...
    const-string v3, "application/x-authoware-map"
    ...
    const-string v3, "application/x-authoware-seg"
    ...
    const-string v4, "audio/x-alpha5"
    ...
    const-string v4, "application/x-mpeg"
    ...
    const-string v6, "application/astound"
    ...
    const-string v7, "application/x-asap"
    ...
    const-string v7, "application/x-bcpio"
    ...
    const-string v7, "application/bld"
    ...
    const-string v7, "application/bld2"
    ...
    const-string v7, "application/x-cnc"
    ...
    const-string v7, "application/x-cocoa"
    ...
    const-string v7, "application/x-netcdf"
    ...
    const-string v7, "magnus-internal/cgi"
    ...
    const-string v7, "application/x-chat"
    ...
    const-string v7, "application/x-msclip"
    ...
    const-string v7, "application/x-cmx"
    ...
    const-string v7, "application/x-cult3d-object"
    ...
    const-string v7, "application/x-mscardfile"
    ...
    const-string v7, "chemical/x-csml"
    ...
    const-string v7, "application/x-expandedbook"
    ...
    const-string v7, "audio/echospeech"
    ...
    const-string v7, "application/x-earthtime"
    ...
    const-string v7, "application/x-envoy"
    ...
    const-string v7, "image/x-freehand"
    ...
    const-string v7, "video/isivideo"
    ...
    const-string v7, "chemical/x-gaussian-input"
    ...
    const-string v7, "application/x-gca-compressed"
    ...
    const-string v10, "application/x-hdf"
    ...
    const-string v10, "application/winhlp"
    ...
    const-string v10, "application/mac-binhex40"
    ...
    const-string v7, "application/x-net-install"
    ...
    const-string v7, "application/x-ipscript"
    ...
    const-string v7, "application/x-ipix"
    ...
    const-string v8, "i-world/i-vrml"
    ...
    const-string v8, "text/vnd.sun.j2me.app-descriptor"
    ...
    const-string v8, "application/x-jam"
    ...
    const-string v8, "application/x-java-jnlp-file"
    ...
    const-string v8, "application/x-javascript"
    ...
    const-string v8, "application/x-kjx"
    ...
    const-string v8, "application/fastman"
    ...
    const-string v8, "application/x-digitalloca"
    ...
    const-string v8, "application/lgh"
    ...
    const-string v8, "x-lml/x-lmlpack"
    ...
    const-string v6, "application/x-msmediaview"
    ...
    const-string v6, "magnus-internal/imagemap"
    ...
    const-string v6, "application/mbedlet"
    ...
    const-string v6, "application/x-mascot"
    ...
    const-string v6, "application/x-msaccess"
    ...
    const-string v6, "application/x-troff-me"
    ...
    const-string v6, "application/ndwn"
    ...
    const-string v6, "application/x-nif"
    ...
    const-string v6, "application/x-scream"
    ...
    const-string v6, "image/vnd.nok-oplogo-color"
    ...
    const-string v6, "application/x-netfpx"
    ...
    const-string v6, "application/x-neva1"
    ...
    const-string v6, "application/x-atlasMate-plugin"
    ...
    const-string v6, "application/x-pan"
    ...
    const-string v6, "chemical/x-pdb"
    ...
    const-string v6, "application/font-tdpfr"
    ...
    const-string v6, "application/x-perl"
    ...
    const-string v6, "application/x-pmd"
    ...
    const-string v6, "application/x-cprplayer"
    ...
    const-string v6, "application/cprplayer"
    ...
    const-string v6, "application/x-prc"
    ...
    const-string v3, "application/listenup"
    ...
    const-string v3, "audio/vnd.qcelp"
    ...
    const-string v3, "image/x-quicktime"
    ...
    const-string v6, "image/vnd.rn-realflash"
    ...
    const-string v6, "application/x-richlink"
    ...
    const-string v8, "image/vnd.rn-realpix"
    ...
    const-string v8, "audio/x-pn-realaudio-plugin"
    ...
    const-string v8, "text/vnd.rn-realtext"
    ...
    sput-object v0, Lyuanwow/foxr/starter/ui/MapTable;->MIME_MapTable:[[Ljava/lang/String;
...
.method public static getMIMEType(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    sget-object v3, Lyuanwow/foxr/starter/ui/MapTable;->MIME_MapTable:[[Ljava/lang/String;
